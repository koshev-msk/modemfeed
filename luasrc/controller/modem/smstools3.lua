...
function index()
	...
	entry({"admin", "modem", "sms"}, alias ("admin", "modem", "sms", "in_sms"), translate("Smstools3 SMS"), 11)
	...
	entry({"admin", "modem", "sms", "setup_sms"}, cbi("modem/smstools3"), translate("Setup"), 25)
	entry({"admin", "modem", "sms", "event"}, form("modem/smsevent"), translate("User Script"), 26)
